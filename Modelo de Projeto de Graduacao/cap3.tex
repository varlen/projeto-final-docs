...
O uso de containers diminui a necessidade do gerenciamento de dependências nos sistemas alvo da implantação, uma vez que estas e suas respectivas configurações
estão inclusas nas imagens utilizadas para montagem.
